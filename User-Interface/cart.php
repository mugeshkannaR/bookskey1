...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<li class="nav-item active">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../Admin-Interface/index.php">ADMIN</a>
      </li>
...
<td><P><?php echo $row['Quantity']?>Pieces</p></td>
...
<!-- Form start -->
<form method="post" action="payment.php" style="margin-left:10%;margin-right:10%;"> 
...
<h4 style="text-align:left;color:red;padding-top:5px;">TOTAL:&nbsp;<i class="fa fa-inr" aria-hidden="true"></i><B><?php echo number_format( $subTotal+($tax * $quan), 2 ); ?></B></h4>
 ...
 <a href="payment.html"><button type="submit" name="submit" value="submit" class="btn btn-outline-success">Save Details</button>&nbsp;</a><button type="reset" class="btn btn-primary" value="clear" >Reset</button>
</form><br>
<!-- Form End -->
</div></div>	
</tr>
...
Mobile: +91 768756574576<br>
Email: ghghchjj@gmail.com<br>
<b>FOR ANY ASSISTANCE</b><br><i class="fa fa-phone"></i>&nbsp;57576576567
<br><br>
</div>

...
<body>
            ...
            <div class="line-flex">
                <div>
                    <form action="insertCart.php" method="post">
                        ...
                        <input type="number" name="qun" value="1" min="1" max="99" style="width:60%;">
    ...
    <div class="footer">
        <div> 
            <img src="../pic/logo1.png" class="logo1">
            <a href="#nav-bar"><i class="fa fa-angle-double-up fa-4x linkUp linkk"></i></a>
        </div>
        <div class="row" style="width:100%;padding-left:60px;padding-top:30px;padding-bottom:20px;">
            <div class="col-md-4">
                <b><h5><i class="fa fa-paper-plane-o"></i>&nbsp;Contact Info :</h5></b>
                Mobile: +91 768756574576<br>
                Email: ghghchjj@gmail.com<br>
                <b>FOR ANY ASSISTANCE</b><br><i class="fa fa-phone"></i>&nbsp;57576576567<br><br>
            </div>
            <div class="col-md-4">
